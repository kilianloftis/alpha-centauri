...
**Area name:** UI — base selector popups
**Output file (write ONLY this file):** `/home/martok/alpha-centauri/review-parts/29-ui-base-selectors.md`

**Assigned files (read every one in full):**
- `src/ui/base/PopTypeSelectorPopup.cpp`
- `include/ui/base/PopTypeSelectorPopup.h`
- `src/ui/base/ProductionSelectorPopup.cpp`
