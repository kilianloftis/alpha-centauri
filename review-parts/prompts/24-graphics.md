...
**Area name:** Graphics backend
**Output file (write ONLY this file):** `/home/martok/alpha-centauri/review-parts/24-graphics.md`

**Assigned files (read every one in full):**
- `src/graphics/NullGraphics.cpp`
- `src/graphics/SFMLGraphics.cpp`
