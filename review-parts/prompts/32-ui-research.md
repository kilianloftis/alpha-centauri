...
**Area name:** UI — research
**Output file (write ONLY this file):** `/home/martok/alpha-centauri/review-parts/32-ui-research.md`

**Assigned files (read every one in full):**
- `src/ui/research/CurrentResearchPanel.cpp`
- `include/ui/research/CurrentResearchPanel.h`
- `src/ui/research/ResearchView.cpp`
