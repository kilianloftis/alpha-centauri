...
**Area name:** Orbital systems
**Output file (write ONLY this file):** `/home/martok/alpha-centauri/review-parts/15-orbital.md`

**Assigned files (read every one in full):**
- `src/game/orbital/OrbitalAttack.cpp`
- `include/game/orbital/OrbitalAttack.h`
- `src/game/orbital/OrbitalCensus.cpp`
