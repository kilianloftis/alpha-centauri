...
// Formula: (baseSize + 1) * nutrientsPerPop / (GrowthRate/100), with GrowthRate seeded at 100.
...
public:
    ...
    static int ComputeNutrientsRequired(const GrowthConfig_t& rConfig, int baseSize,
