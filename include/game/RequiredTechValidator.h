...
// TechRegistry. Call once after all registries are loaded so a typo'd required_tech fails at
// startup, instead of leaving the entry permanently unavailable (ValidateEffectReferences
// covers effect-list references; this covers the separate requiredTech field every one of
// these config types also carries).
