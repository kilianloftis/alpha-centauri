...
// on ImprovementConfig_t as fragments (JSON move_cost, and move_cost MaxClamp amounts, are
// converted at parse via k_moveFragmentsPerPoint so fractional roads ("1/3") land on whole
// fragments).
